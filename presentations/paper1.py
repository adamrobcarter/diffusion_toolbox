...
import box_counting.merge_msds
...
DS_OVERLAPPED_XLIM1280 = (0.05, 82)
# DS_OVERLAPPED_XLIM_K = (2*np.pi/50, 2*np.pi/0.05)
DS_OVERLAPPED_XLIM_K = (0.26, 45)
DS_OVERLAPPED_XLIM_L_FOR_FKT = (0.13, 50)
DS_OVERLAPPED_XLIM_L_FOR_FKT1280 = (0.13, 82)

ticks_0p5 = plt.MultipleLocator(base=0.5)

LEGEND_FONTSIZE=8

# SIMULATION_SOURCE_011 = 'sim_nohydro_011_L640'
# SIMULATION_SOURCE_002 = 'sim_nohydro_002_L640'
...
if __name__ == '__main__':
    ...
    # show_png(ax_d, 'presentations/paper1/fig1_sketch2.png')
    ...
    # box_counting.D_of_L.go(
    #     f'{SIMULATION_SOURCE_011}_longer_merged',
    #     'var', #'nmsdfitinter',
    #     ax=ax_a,
    #     **D_of_L_props,
    # )
    ...
    #     [f'{SIMULATION_SOURCE_002}_longer_{MERGE_TYPE_TIMESCALEINT}', f'{SIMULATION_SOURCE_011}_longer_{MERGE_TYPE_TIMESCALEINT}'],
    #     ax=ax_c,
    #     **Ds_ov_mult_props
    ...
    # visualisation.Ds_overlapped_mult.go(
    #     [f'{SIMULATION_SOURCE_002}_longer_{MERGE_TYPE_NMSD_FIT}', f'{SIMULATION_SOURCE_011}_longer_{MERGE_TYPE_NMSD_FIT}'], # this used to not be merged
    #     ax=ax_c,
    #     **Ds_mult_props
    # )
    # ax_c.set_ylim(*DS_OVERLAPPED_YLIM)
    ...
    visualisation.Ds_overlapped_mult.go(
        [f'{SIMULATION_SOURCE_002}_longer_{MERGE_TYPE_TIMESCALEINT}', f'{SIMULATION_SOURCE_011}_longer_{MERGE_TYPE_TIMESCALEINT}'],#, 'brennan_hydro_011_L320'],
        ax=ax_a,
        **fig7_props
    )
    ...
    visualisation.Ds_overlapped_mult.go(
        [f'{SIMULATION_SOURCE_011}_longer_{MERGE_TYPE_TIMESCALEINT}'],
        ax=ax_a,
        **fig8_props
    )
