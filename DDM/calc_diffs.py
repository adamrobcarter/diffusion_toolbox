...
for file in common.files_from_argv('preprocessing/data', 'stack_'):
    ...
    def callback(i, k, F_D_sq, F_D_sq_unc, t, F_D_sq_all, time_origins):
        if i % 10 == 0 or i in [1, 3, 5, 15]:
            ...
            common.save_data(f'DDM/data/ddm_{file}_diffs.npz', quiet=True,
                k=k, F_D_sq=F_D_sq, F_D_sq_unc=F_D_sq_unc, t=t,
                use_every_nth_frame=0,
    ...
    t0 = time.time()
    k, t, F_D_sq, F_D_sq_unc, use_every_nth_frame, F_D_sq_all, time_origins = DDM.DDM.calc(stack, pixel_size, time_step, num_k_bins, callback=callback)
    t1 = time.time()

    common.save_data(f'DDM/data/ddm_{file}_diffs.npz', k=k, F_D_sq=F_D_sq, F_D_sq_unc=F_D_sq_unc, t=t,
        use_every_nth_frame=use_every_nth_frame,
