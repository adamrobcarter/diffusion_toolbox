...
def go(files):
    ...
    if data0['time_step'] == 0.5 and data1['time_step'] == 16:
        CROSSOVER_TIME = 992
    if data0['time_step'] == 0.5 and data1['time_step'] == 64:
        CROSSOVER_TIME = 1024
    ...
    N_var_sem_lb = concat_L(data1['N_var_sem_lb'], data0['N_var_sem_lb'])
    N_var_sem_ub = concat_L(data1['N_var_sem_ub'], data0['N_var_sem_ub'])
    print(data0['N_var'])
    print(data1['N_var'])
    print(N_var)
    ...
    dataout = dict(
        ...
        N_mean            = N_mean_avg,
        N_var             = N_var,
        N_var_sem_lb      = N_var_sem_lb,
        N_var_sem_ub      = N_var_sem_ub,
