...
for file in common.files_from_argv('scattering_functions/data', 'F_'):
    ...
    fig, axs = plt.subplots(1, NUM_Ts, figsize=(3*NUM_Ts, 3.2))
    ...
    common.save_fig(fig_single, f'scattering_functions/data/decaytime_single_{file}.png')
    common.save_fig(fig, f'scattering_functions/data/decaytime_{file}.png')