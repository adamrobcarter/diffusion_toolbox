import numpy as np
import scattering_functions.scattering_functions_atooms as scattering_functions
import common
import time
import sys
...
# for F_type in F_types:
    ...
    Fs, F_unc, ks, t = scattering_functions.intermediate_scattering(log, F_type, crop, num_k_bins, num_iters, d_frames, particles, num_frames, max_K, width=width, height=height)
    ...
    np.savez(f"scattering_functions/data/{F_type}_{file}_atooms", F=Fs, F_unc=F_unc, k=ks, t=d_frames*time_step, crop=crop,
