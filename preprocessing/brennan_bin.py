...
#     (544, 0.5, 0.1, '_dt0.5', 1, 24*60*60/0.5),
#     # (800, 8, 0.02, '', 1, 24*60*60/8),
# ]

# for L, dt, phi, suffix, nth_timestep, max_frames in datas:
#     phistr = f'{phi*100:.0f}'.zfill(3)
#     go(f'/data2/acarter/sim/RigidMultiblobsWall/Lubrication/Lubrication_Examples/Monolayer/data/nohydro2D_L{L}_dt{dt}_bin.suspension_phi_{phi}_L_{L}.bin', f'sim_nohydro_{phistr}_L{L}{suffix}',  L, L, dt, phi, nth_timestep, max_frames)
