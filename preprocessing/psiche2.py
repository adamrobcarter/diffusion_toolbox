...
for file in sys.argv[1:]:
    ...
    with h5py.File(f'raw_data/psiche/{file}/pre_ref.nxs', 'r') as f:
        ...
        # entry = f['entry']
        # scan_data = entry['scan_data']
        # print(', '.join([a for a in scan_data]))
        # print(type(scan_data), scan_data)
        print(refA.shape, refA_mean.shape)

        # print('close', np.isclose(ref0_mean, refA))
        # print(refA)
        # print(ref0_mean)
