...
hydrofile_wall          = '/data2/acarter/direct_to_H/' f'data/H_of_k_L300_numkbins60_single_wall_walllub_phi0.181_maxk10.0_montecarlo_full_zpos1.20_zwidth0.0a_numis200.npz'
hydrofile_wall2         = '/data2/acarter/direct_to_H/' f'data/H_of_k_L300_numkbins60_single_wall_walllub_phi0.181_maxk10.0_montecarlo_full_zpos1.05_zwidth0.0a_numis200.npz'
...
visualisation.Ds_overlapped_mult.go(
    (
        ...
        dict(
            ...
            label = f'theory, hydro + lubrication $h=1.2a$',
            phi = phi,
            sigma = sigma,
            Lmax = 500,
            color = 'tab:orange'
        ...
        dict(
            ...
            label = f'theory, hydro + lubrication $h=1.05a$',
            phi = phi,
            sigma = sigma,
            Lmax = 500,
            color = 'tab:red'
        ...
        dict(
            ...
            # plot_index=np.index_exp[30:-30],
            # msd_file='eleanorsmall016short',
            hydro_source_file=hydrofile_wall2,
            label = f'theory, hydro + lubrication $h=1.05a$',
            phi = phi,
            sigma = sigma,
            Lmax = 500,
