...
for file in common.files_from_argv('particle_detection/data', 'particles_'):
    ...
    crop_width = 200
    crop_start = 300 if file == 'brennan_hydro_010_L800' else 0
    ...
    common.save_data(f'particle_detection/data/particles_{file}_cropbrennan.npz', **newdata)
    if particles.shape[1] == 4:
        common.save_data(f'particle_linking/data/trajs_{file}_cropbrennan.npz', **newdata)